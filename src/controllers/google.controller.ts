...
import {GetGoogleLoginUrl, GetGoogleUserInfoFromCode} from '../usecases/google';
...
export class GoogleController {
  ...
  async login(
    ...
    try {
      const googleLoginUrl = await new GetGoogleLoginUrl().execute(redirectUri, invitationId);
